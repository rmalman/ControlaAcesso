...
{
    public class ControlaAcessoInitializer : DropCreateDatabaseIfModelChanges<ControlaAcessoContext>
    {
        ...
        private void createRolesandUsers()
        {
            ...
            if (!roleManager.RoleExists("Gerencia"))
            {
                var role = new Microsoft.AspNet.Identity.EntityFramework.IdentityRole();
                role.Name = "Gerencia";
                roleManager.Create(role);
            ...
            if (!roleManager.RoleExists("Equipe"))
            {
                var role = new Microsoft.AspNet.Identity.EntityFramework.IdentityRole();
                role.Name = "Equipe";
                roleManager.Create(role);
